    ...
    case "user": {
      ...
      for (const block of contentBlocks) {
        ...
        if (typeof block.content === "string") {
          ...
          for (const c2 of block.content) {
            if (typeof c2 === "string") outputChunks.push(c2);
            else if (c2 && typeof c2.text === "string") outputChunks.push(c2.text);
          }
...
${args.prompt}`;
    ...
    const baseOptions = {
      ...
      // Pass system prompt so agent knows it's a Flutter/Expo builder
