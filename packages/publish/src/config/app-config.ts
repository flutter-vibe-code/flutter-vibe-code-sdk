 ...
 * @example
 * ```typescript
 * import { updateAppJsonWithName } from '@flutter-vibe-code/publish/config'
 *
 ...
 * @example
 * ```typescript
 * import { updateWranglerTomlWithName } from '@flutter-vibe-code/publish/config'
 *
 ...
 * @example
 * ```typescript
 * import { updateAppConfigWithName } from '@flutter-vibe-code/publish/config'
 *
