...
export function ChatInput({
  ...
  return (
    <form
      ...
      className="mb-2 mt-auto flex flex-col max-w-[755px] mx-auto"
    ...
    >
      ...
      <div className="relative">
        <div
          className={`shadow-[0_10px_40px_-12px_rgba(0,0,0,0.18)] rounded-2xl relative z-10 bg-background/65 supports-[backdrop-filter]:bg-background/45 backdrop-blur-2xl backdrop-saturate-150 border border-border/40 ring-1 ring-black/5 dark:ring-white/5 pt-2 mb-4 ${
            dragActive
        ...
        >
          ...
          <div className="flex p-3 gap-2 items-center justify-between">
            ...
            <div className="flex items-center gap-2 ">
              ...
              <ProviderSelector disabled={isLoading || isErrored} />
            </div>
