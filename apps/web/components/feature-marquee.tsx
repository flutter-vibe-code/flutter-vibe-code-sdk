...
export const FEATURES = [
  ...
  },
  {
    ...
    description: 'Vibe code inside your app preview on Flutter. Real-time editing.',
    icon: <Smartphone className="w-5 h-5 text-indigo-500" />,
    bg: 'bg-indigo-500/10',
    color: 'text-indigo-500',
    content: (
      <div className="space-y-4">
        <p className="text-muted-foreground">The ultimate mobile development experience. Open the floating AI button inside Flutter to modify your code while you use the app.</p>
