...
const AGENTS: { id: AgentType; name: string; description: string }[] = [
  { id: 'claude-code', name: 'Claude Code', description: 'Routed via Claude Agent SDK · Anthropic-compat' },
]
...
export function ClaudeModelSelector({
  ...
  // Only one agent now (Claude Agent SDK). Multi-provider via baseURL.
      ...
      <DialogTrigger asChild>
        ...
        >
          ...
          <span className="hidden sm:inline">
            Claude Code · {getClaudeModelById(resolvedValue)?.name || models[0]?.name}
          </span>
