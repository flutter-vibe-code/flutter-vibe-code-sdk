...
export function SubscriptionModal({
  ...
  const handleManageSubscription = async () => {
    if (!subscriptionStatus?.customerId) {
      toast({
        title: 'Error',
        description: 'No customer account found. Please subscribe first.',
        variant: 'destructive',
      })
      return
    }
        ...
        <div className="p-6 pb-0">
          <DialogHeader>
            ...
            <div className="text-center mt-2 bg-muted border border-border rounded-lg px-4 py-3 text-sm text-foreground">
              ...
              We have halved plan prices ✂️🥳 . Flutter Vibe Code is now the most affordable vibe coding platform to create Flutter apps. We will keep pushing to make the project the most open and affordable option to easily vibe code React Rative apps. Enjoy.
            </div>
            <Button
              variant="ghost"
              size="icon"
