  ...
  try {
    ...
    if (sandboxId) {
      try {
        ...
        // Check if port 3000 is listening (Flutter web-server default).
        // Migrated from 8081 (Expo legacy) — startFlutterServer binds 3000.
        const checkPortCmd = 'ss -tuln 2>/dev/null | grep -q :3000 && echo "LISTENING" || echo "NOT_LISTENING"'
