  ...
  try {
    ...
    if (action === 'structure') {
      ...
      const structureResult = await sbx.commands.run(
        `cd /home/user/app && find . -type f \\( -name "*.dart" -o -name "*.yaml" -o -name "*.yml" -o -name "*.lock" -o -name "*.json" -o -name "*.md" -o -name "*.gradle" -o -name "*.kt" -o -name "*.swift" -o -name "*.m" -o -name "*.xml" -o -name "*.plist" -o -name "*.xcconfig" -o -name "*.html" -o -name "*.css" -o -name "*.js" -o -name "*.ts" \\) | grep -vE "node_modules|\\.dart_tool|/build/|\\.git/" | head -200 | sort | sed 's|^./||'`,
        { timeoutMs: 5 * 60 * 1000 },
      )
      ...
      const findCommand = `find /home/user/app -type f \\( -name "*.dart" -o -name "*.yaml" -o -name "*.yml" -o -name "*.lock" -o -name "*.json" -o -name "*.md" -o -name "*.gradle" -o -name "*.kt" -o -name "*.swift" -o -name "*.m" -o -name "*.xml" -o -name "*.plist" -o -name "*.xcconfig" -o -name "*.html" -o -name "*.css" -o -name "*.js" -o -name "*.ts" \\) | grep -vE "node_modules|\\.dart_tool|/build/|\\.git/" | head -200`
