...
const githubService = new GitHubService({
  owner: process.env.GITHUB_OWNER || 'flutter-vibe-code',
  token: process.env.GITHUB_TOKEN!,
})

// E2B template IDs
const TEMPLATE_ID = 'sce6zutko6kvhyhza4n8' // flutter template
...
export async function POST(request: NextRequest) {
  try {
    ...
    const owner = process.env.GITHUB_OWNER || 'flutter-vibe-code'
    try {
