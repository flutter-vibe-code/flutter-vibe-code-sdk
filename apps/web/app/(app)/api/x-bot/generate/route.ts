...
async function sendErrorReply(
  ...
  try {
    ...
    const errorText = `Sorry @${username}, there was an issue creating your app. Please try again or visit fluttervibecode.dpdns.org to build it manually.`
...
function buildPrompt(appDescription: string, hasImages: boolean, mentionText?: string, parentTweetText?: string): string {
  let prompt = 'Create a Flutter Expo mobile app based on this request:\n\n'
  ...
  prompt += `Requirements:
- Create a functional mobile app using Flutter and Expo
- Use a clean, modern UI design
- Make sure the app runs without errors
- Focus on the core functionality described
- Use appropriate Flutter components and styling
