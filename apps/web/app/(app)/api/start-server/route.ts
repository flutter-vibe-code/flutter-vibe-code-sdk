...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      if (project.serverStatus === 'running' && project.sandboxUrl && project.e2bUrl) {
    ...
    try {
      ...
      const serverResult = await startFlutterServer(sandbox, projectId, undefined, currentTunnelMode as any)
