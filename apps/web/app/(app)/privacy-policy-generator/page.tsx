...
export const metadata: Metadata = {
  metadataBase: new URL('https://fluttervibecode.dpdns.org'),
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://fluttervibecode.dpdns.org/privacy-policy-generator',
    siteName: 'Capsule',
  ...
  alternates: {
    canonical: 'https://fluttervibecode.dpdns.org/privacy-policy-generator',
  },
}
              ...
              <div className="max-w-xl flex flex-row items-center flex-wrap">
                <div className="min-w-full p-4 rounded-lg bg-muted-foreground/5 border border-muted-foreground/10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="hidden md:block text-sm text-muted-foreground font-mono">https://fluttervibecode.dpdns.org/policy/7c4b6f8e1e9a</span>
