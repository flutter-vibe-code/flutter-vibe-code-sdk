...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://fluttervibecode.dpdns.org/exa/people-search',
    siteName: 'Capsule',
    title: 'Exa App Generator - Build People Search Apps | Capsule',
  ...
  alternates: {
    canonical: 'https://fluttervibecode.dpdns.org/exa/people-search',
  },
}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              <div className="w-full">
                ...
                <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-4">
                  Get fully functional Flutter and web apps with beautiful UIs, real-time search,
