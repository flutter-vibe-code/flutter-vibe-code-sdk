...
const ALLOWED_ORIGINS = [
  // Primary domain
  'https://fluttervibecode.dpdns.org',
  'https://fluttervibecode.dpdns.org',
  'https://fluttervibecode.dpdns.org',
  'http://localhost:3000',
  'http://localhost:3210',
...
const WILDCARD_ALLOWED_DOMAINS = [
  ...
  'fluttervibecode.dpdns.org',  // Flutter Vibe Code subdomains (*.fluttervibecode.dpdns.org)
]
...
function isOriginAllowed(origin: string | null): boolean {
  ...
  // Allow Flutter development URLs (exp://192.168.x.x:8081)
