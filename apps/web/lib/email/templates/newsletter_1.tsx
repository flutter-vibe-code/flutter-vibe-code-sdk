...
export default function NewsletterEmail({
  previewText = "What's new at Flutter Vibe Code",
  issueNumber = 1,
  issueDate = 'March 2026',
  heading = "What's New at Flutter Vibe Code",
  intro = "Hey everyone 👋. It's been 3 weeks since the release of Flutter Vibe Code. The feedback has been very positive and overwelming. More that 500 users and thousands of apps created already. That is great but we got a lot of feedback on bugs. So we got to work on them and we just released a bunch of fixes. Here's what we've been working on to make your vibe coding experience even better.",
  updates = defaultUpdates,
  closingTitle = 'Try It Out',
  closingText = 'All of these improvements are live right now. Jump in and start building.',
  ctaText = 'Open Flutter Vibe Code',
  ctaUrl = 'https://fluttervibecode.dpdns.org?utm_source=newsletter&utm_medium=email&utm_campaign=newsletter_1&utm_content=cta_button',
  unsubscribeUrl,
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={quickLinksSection}>
            <Button style={quickLinkButton} href="https://fluttervibecode.dpdns.org?utm_source=newsletter&utm_medium=email&utm_campaign=newsletter_1&utm_content=launch_button">
              Launch Flutter Vibe Code
            </Button>
            <Button style={quickLinkButtonOutline} href="https://github.com/flutter-vibe-code/flutter-vibe-code-sdk">
          ...
          <Text style={updateText}>
            ...
            we're bringing it to Flutter Vibe Code. Its power comes from
          ...
          <Text style={footer}>
            ...
            <Link
              target="_blank"
              href="https://fluttervibecode.dpdns.org"
              style={link}
            >
              Flutter Vibe Code
            </Link>
...
const defaultUpdates: NewsletterUpdate[] = [
  {
    ...
    linkUrl: 'https://fluttervibecode.dpdns.org/subscription?utm_source=newsletter&utm_medium=email&utm_campaign=newsletter_1&utm_content=check_plans',
