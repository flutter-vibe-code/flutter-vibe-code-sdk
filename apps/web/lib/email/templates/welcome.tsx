...
export default function WelcomeEmail({ name, unsubscribeUrl }: WelcomeEmailProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to Flutter Vibe Code - Vibe code mobile and web apps with AI</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>Welcome to Flutter Vibe Code!</Heading>

          <Text style={text}>Hi {firstName},</Text>

          <Text style={text}>
            You're in! <Link target='_blank' href="https://fluttervibecode.dpdns.org" style={link}>Flutter Vibe Code</Link> lets you turn text to web and native apps at the same time by just prompting. It is also the first open source Flutter IDE so all the code is available for you to run locally if you want, explore or bring up a PR to support the community.
          </Text>
          ...
          <Section style={pricingSection}>
            ...
            <Section style={pricingCard}>
              ...
              <Section style={buttonSection}>
                <Button style={button} href="https://fluttervibecode.dpdns.org/subscribe">
                  Subscribe
                </Button>
              </Section>
            </Section>
          ...
          <Section style={buttonSection}>
            <Button style={button} href="https://fluttervibecode.dpdns.org">
              Start Building
            </Button>
          </Section>
          ...
          <Text style={footer}>
            Need help?{' '}
            <Link href="mailto:rodrigo@fluttervibecode.dpdns.org" style={link}>
              Contact us
            </Link>
          </Text>

          <Text style={footer}>
          <Link target='_blank' href="https://fluttervibecode.dpdns.org" style={link}>Flutter Vibe Code</Link> - Text to mobile & web apps in seconds
          </Text>
          {/* {unsubscribeUrl && (
            <Text style={footer}>
