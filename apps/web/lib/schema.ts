...
export const fragmentSchema = z.object({
  ...
  file_path: z
    .string()
    .describe(
      'Relative path to the file, including the file name. For Flutter Expo: use "App.tsx" for main file, "components/ComponentName.tsx" for components, "screens/ScreenName.tsx" for screens. For Next.js: use "pages/index.tsx" or "pages/[name].tsx". For Python: use "script.py" or "app.py".',
    ),
  code: z
    .string()
