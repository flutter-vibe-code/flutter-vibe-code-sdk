  ...
  async generateAppStreaming(
    ...
    try {
      ...
      try {
        ...
        const providerEnvs = buildProviderEnv(provider, apiKeyToUse, request.claudeModel, request.effortLevel as any)
        ...
        const sandboxTimeoutMs = parseInt(process.env.E2B_SANDBOX_TIMEOUT_MS || '3600000', 10)
