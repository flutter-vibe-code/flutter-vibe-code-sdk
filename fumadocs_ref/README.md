# Flutter Vibe Code Documentation Reference

This directory contains comprehensive documentation for Flutter Vibe Code in Fumadocs-compatible MDX format.
...
3. **Developer Resources** - Complete API and feature documentation for developers integrating with Flutter Vibe Code
...
**Target Audience:** Mobile app developers calling APIs from Flutter/Expo
...
- Rate limiting
- CORS configuration
- SDK examples (JavaScript, Flutter, cURL)

**Target Audience:** All developers integrating with Flutter Vibe Code
...
- Generating code that integrates with Flutter Vibe Code
...
- **Email:** support@flutter-vibe-code.dev

## License

This documentation is part of the Flutter Vibe Code project. See the main project LICENSE for details.
...
**Flutter Vibe Code Version:** Compatible with current main branch
