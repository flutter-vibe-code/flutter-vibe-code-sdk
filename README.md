...
The first open-source IDE that creates mobile apps with AI. Build Flutter and Flutter applications through natural language.

Try it on [flutter-vibe-code.dev](https://flutter-vibe-code.dev)
...
```bash
git clone https://github.com/flutter-vibe-code/flutter-vibe-code-sdk.git flutter-vibe-code

cd flutter-vibe-code
```
...
3. Watch as the AI generates Flutter/Expo code
